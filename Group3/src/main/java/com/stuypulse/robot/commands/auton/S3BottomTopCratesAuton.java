...
public class S3BottomTopCratesAuton extends SequentialCommandGroup {

    String S3toP2 = "StoP/output/S3toP2.wpilib.json";
    ...
    public S3BottomTopCratesAuton(RobotContainer robot){
        addCommands(
